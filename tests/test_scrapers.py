...
async def test_cinematheque_search_script_success(cinematheque_scraper):
    ...
    # Setup mock response
    mock_response = cinematheque_scraper._session.get.return_value.__aenter__.return_value
    mock_response.status = 200
...
async def test_cinematheque_get_script_success(cinematheque_scraper):
    ...
    script = await cinematheque_scraper.get_script("https://cinematheque.fr/films/test-movie")
